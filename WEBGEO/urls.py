...
urlpatterns = [
    ...
    path('quiz_result/<int:quiz_id>/<int:quiz_attempt_id>/', views.quiz_result, name='quiz_result'),
    path('quiz_question/<int:quiz_attempt_id>/<int:current_question>/', views.quiz_question, name='quiz_question'),
